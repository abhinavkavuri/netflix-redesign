...
var App = React.createClass({
	...
	render: function render() {
		...
		return React.createElement(
			...
			React.createElement(TitleList, { title: 'Top TV picks for abhinav', url: 'discover/tv?sort_by=popularity.desc&page=1' }),
		...
		return React.createElement(
			...
			React.createElement(
				...
				React.createElement(
					'div',
					{ className: 'image' },
					React.createElement('img', { src: 'https://avatars1.githubusercontent.com/u/21124185?s=460&v=4' })
				)
			),
			React.createElement(
				'div',
